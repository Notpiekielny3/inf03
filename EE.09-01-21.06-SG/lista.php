...
<body>
	...
	<section id="main">
		...
		<?php
			...
			// wysylanie zapytania i otrzymywanie wynikow
			...
			// wyprowadzenie danych na przegladarke
			while($rekord = mysqli_fetch_array($wynik_zapytania)) {
				// stosujac instrukcje echo wypisz kolejne bloki danych 
				echo '<div class="person">';
					echo '<div class="blok_foto">';
						echo '<img src="'. $rekord['zdjecie'] . '">';
					echo '</div>';
					echo '<div class="opis">';
						echo '<h3>'. $rekord['imie'] . ' '  . $rekord['nazwisko'] ;
						echo '</h3>';
